 ...
 *         &lt;element name="studentList" type="{http://www.howtodoinjava.com/xml/school}StudentM2" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class StudentBySchoolResponse {
    ...
    protected List<StudentM2> studentList;
     ...
     * 
     */
    public List<StudentM2> getStudentList() {
        if (studentList == null) {
            studentList = new ArrayList<StudentM2>();
        }
